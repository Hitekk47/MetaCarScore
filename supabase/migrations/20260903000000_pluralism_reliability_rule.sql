-- Migration: 20260903000000_pluralism_reliability_rule.sql
-- Description: Transition from raw review count threshold (total_reviews >= 3) to media source pluralism threshold (COUNT(DISTINCT TRIM("Testeur")) >= 3) for vehicle reliability, rankings, SEO stats, and sitemaps.

-- -----------------------------------------------------------------------------
-- 1. get_vehicle_seo_stats_v4
-- -----------------------------------------------------------------------------
CREATE OR REPLACE FUNCTION "public"."get_vehicle_seo_stats_v4"(
  "p_marque" "text",
  "p_famille" "text",
...
REVOKE ALL ON FUNCTION "public"."get_vehicle_seo_stats_v4"("text", "text", integer, "text") FROM "anon", "authenticated";
GRANT EXECUTE ON FUNCTION "public"."get_vehicle_seo_stats_v4"("text", "text", integer, "text") TO "anon", "authenticated", "service_role";


-- -----------------------------------------------------------------------------
-- 2. get_model_ranking_v5
-- -----------------------------------------------------------------------------
CREATE OR REPLACE FUNCTION "public"."get_model_ranking_v5"(
...
REVOKE ALL ON FUNCTION "public"."get_model_ranking_v5"(integer, "text", "text", "text", "text", integer) FROM "anon", "authenticated";
GRANT EXECUTE ON FUNCTION "public"."get_model_ranking_v5"(integer, "text", "text", "text", "text", integer) TO "anon", "authenticated", "service_role";


-- -----------------------------------------------------------------------------
-- 3. get_break_ranking_v3 & get_convertible_ranking_v3
-- -----------------------------------------------------------------------------
CREATE OR REPLACE FUNCTION "public"."get_break_ranking_v3"(
  "min_my" integer DEFAULT NULL::integer,
  "limit_val" integer DEFAULT 100
) RETURNS TABLE(
  "Marque" "text",
...
REVOKE ALL ON FUNCTION "public"."get_break_ranking_v3"(integer, integer) FROM "anon", "authenticated";
GRANT EXECUTE ON FUNCTION "public"."get_break_ranking_v3"(integer, integer) TO "anon", "authenticated", "service_role";


CREATE OR REPLACE FUNCTION "public"."get_convertible_ranking_v3"(
  "min_my" integer DEFAULT NULL::integer,
  "limit_val" integer DEFAULT 100
) RETURNS TABLE(
  "Marque" "text",
...
REVOKE ALL ON FUNCTION "public"."get_convertible_ranking_v3"(integer, integer) FROM "anon", "authenticated";
GRANT EXECUTE ON FUNCTION "public"."get_convertible_ranking_v3"(integer, integer) TO "anon", "authenticated", "service_role";


-- -----------------------------------------------------------------------------
-- 4. get_trending_models_v3
-- -----------------------------------------------------------------------------
CREATE OR REPLACE FUNCTION "public"."get_trending_models_v3"(
...
BEGIN
  ...
  HAVING COUNT(DISTINCT TRIM(nr."Testeur")) >= 3
  ORDER BY MIN(nr."Test_date") DESC
  LIMIT limit_val;
END;
$$;

REVOKE ALL ON FUNCTION "public"."get_trending_models_v3"(integer) FROM "anon", "authenticated";
GRANT EXECUTE ON FUNCTION "public"."get_trending_models_v3"(integer) TO "anon", "authenticated", "service_role";


-- -----------------------------------------------------------------------------
-- 5. get_brand_ranking_v7
-- -----------------------------------------------------------------------------
CREATE OR REPLACE FUNCTION "public"."get_brand_ranking_v7"(
    "min_my" integer DEFAULT NULL::integer,
...
REVOKE ALL ON FUNCTION "public"."get_brand_ranking_v7"(integer, integer) FROM "anon", "authenticated";
GRANT EXECUTE ON FUNCTION "public"."get_brand_ranking_v7"(integer, integer) TO "anon", "authenticated", "service_role";


-- -----------------------------------------------------------------------------
-- 6. get_sitemap_groups_filtered_v3
-- -----------------------------------------------------------------------------
CREATE OR REPLACE FUNCTION "public"."get_sitemap_groups_filtered_v3"()
RETURNS TABLE(
  "marque" "text",
  "famille" "text",
  "my" "text",
...
REVOKE ALL ON FUNCTION "public"."get_sitemap_groups_filtered_v3"() FROM "anon", "authenticated";
GRANT EXECUTE ON FUNCTION "public"."get_sitemap_groups_filtered_v3"() TO "anon", "authenticated", "service_role";


-- -----------------------------------------------------------------------------
-- 7. get_sitemap_canonical_routes_v2
-- -----------------------------------------------------------------------------
CREATE OR REPLACE FUNCTION "public"."get_sitemap_canonical_routes_v2"()
RETURNS TABLE(
  "route_type" "text",
  "marque" "text",
  "famille" "text",
...
REVOKE ALL ON FUNCTION "public"."get_sitemap_canonical_routes_v2"() FROM "anon", "authenticated";
GRANT EXECUTE ON FUNCTION "public"."get_sitemap_canonical_routes_v2"() TO "anon", "authenticated", "service_role";
